...
s = function() {
	...
	([function(e, t, i) {
		...
		function r(e, t, i) {
			var s = null,
				r = function(e, t) {
					i && i(e, t), s && s.visit(e, t)
				},
				n = "function" == typeof i ? r : null,
				a = !1;
			if (t) {
				a = "boolean" == typeof t.comment && t.comment;
				var o = "boolean" == typeof t.attachComment && t.attachComment;
				(a || o) && ((s = new l.CommentHandler).attach = o, t.comment = !0, n = r)
			}
			var u, h = !1;
			t && "string" == typeof t.sourceType && (h = "module" === t.sourceType), u = t && "boolean" == typeof t.jsx && t.jsx ? new p.JSXParser(e, t, n) : new d.Parser(e, t, n);
			var c = h ? u.parseModule() : u.parseScript();
			return a && s && (c.comments = s.comments), u.config.tokens && (c.tokens = u.tokens), u.config.tolerant && (c.errors = u.errorHandler.errors), c
		}
		t.parse = r, t.parseModule = function(e, t, i) {
			var s = t || {};
			return s.sourceType = "module", r(e, s, i)
		}, t.parseScript = function(e, t, i) {
			var s = t || {};
			return s.sourceType = "script", r(e, s, i)
			...
			return r.errorHandler.tolerant && (s.errors = r.errors()), s
		};
		var s = i(2);
		t.Syntax = s.Syntax, t.version = "4.0.1"
	}, function(e, t, i) {
		"use strict";
		Object.defineProperty(t, "__esModule", {
			value: !0
			...
			s = function() {
				...
				return e.prototype.insertInnerComments = function(e, t) {
					if (e.type === n.Syntax.BlockStatement && 0 === e.body.length) {
						for (var i = [], s = this.leading.length - 1; 0 <= s; --s) {
							var r = this.leading[s];
							t.end.offset >= r.start && (i.unshift(r.comment), this.leading.splice(s, 1), this.trailing.splice(s, 1))
						}
					...
					if (r && r.node.trailingComments) {
						...
						n && n.range[0] >= e.end.offset && (t = r.node.trailingComments, delete r.node.trailingComments)
					}
					return t
				}, e.prototype.findLeadingComments = function(e) {
					for (var t, i = []; 0 < this.stack.length;) {
						if (!((n = this.stack[this.stack.length - 1]) && n.start >= e.start.offset)) break;
						t = n.node, this.stack.pop()
					}
					if (t) {
						for (var s = (t.leadingComments ? t.leadingComments.length : 0) - 1; 0 <= s; --s) {
							var r = t.leadingComments[s];
							r.range[1] <= e.start.offset && (i.unshift(r), t.leadingComments.splice(s, 1))
						}
						return t.leadingComments && 0 === t.leadingComments.length && delete t.leadingComments, i
					}
					for (s = this.leading.length - 1; 0 <= s; --s) {
						var n;
						(n = this.leading[s]).start <= e.start.offset && (i.unshift(n.comment), this.leading.splice(s, 1))
					}
					return i
				}, e.prototype.visitNode = function(e, t) {
					if (!(e.type === n.Syntax.Program && 0 < e.body.length)) {
						this.insertInnerComments(e, t);
						var i = this.findTrailingComments(t),
							s = this.findLeadingComments(t);
						0 < s.length && (e.leadingComments = s), 0 < i.length && (e.trailingComments = i), this.stack.push({
							node: e,
		...
		"use strict";
		var s, r = this && this.__extends || (s = Object.setPrototypeOf || {
				__proto__: []
			}
		...
		var d = function(s) {
			function e(e, t, i) {
				return s.call(this, e, t, i) || this
			}
			return r(e, s), e.prototype.parsePrimaryExpression = function() {
				return this.match("<") ? this.parseJSXRoot() : s.prototype.parsePrimaryExpression.call(this)
			...
			}, e.prototype.scanXHTMLEntity = function(e) {
				for (var t = "&", i = !0, s = !1, r = !1, n = !1; !this.scanner.eof() && i && !s;) {
					var a = this.scanner.source[this.scanner.index];
					if (a === e) break;
					if (s = ";" === a, t += a, ++this.scanner.index, !s) switch (t.length) {
						case 2:
							r = "#" === a;
							break;
						case 3:
							r && (i = (n = "x" === a) || u.Character.isDecimalDigit(a.charCodeAt(0)), r = r && !n);
							break;
						default:
							i = (i = i && !(r && !u.Character.isDecimalDigit(a.charCodeAt(0)))) && !(n && !u.Character.isHexDigit(a.charCodeAt(0)))
					}
				}
				if (i && s && 2 < t.length) {
					var o = t.substr(1, t.length - 2);
					r && 1 < o.length ? t = String.fromCharCode(parseInt(o.substr(1), 10)) : n && 2 < o.length ? t = String.fromCharCode(parseInt("0" + o.substr(1), 16)) : r || n || !l.XHTMLEntities[o] || (t = l.XHTMLEntities[o])
				}
				return t
				...
				if (34 === e || 39 === e) {
					for (var t = this.scanner.index, i = this.scanner.source[this.scanner.index++], s = ""; !this.scanner.eof();) {
						if ((o = this.scanner.source[this.scanner.index++]) === i) break;
						s += "&" === o ? this.scanXHTMLEntity(i) : o
					}
					return {
						type: 8,
						value: s,
				...
				if (46 === e) {
					var r = this.scanner.source.charCodeAt(this.scanner.index + 1),
						n = this.scanner.source.charCodeAt(this.scanner.index + 2),
						a = 46 === r && 46 === n ? "..." : ".";
				...
				if (u.Character.isIdentifierStart(e) && 92 !== e) {
					...
					for (++this.scanner.index; !this.scanner.eof();) {
						...
						if (u.Character.isIdentifierPart(o) && 92 !== o) ++this.scanner.index;
						else {
							if (45 !== o) break;
							++this.scanner.index
						}
				...
				if (this.matchJSX(":")) {
					...
					t = this.finalize(e, new o.JSXNamespacedName(i, s))
				} else if (this.matchJSX("."))
					for (; this.matchJSX(".");) {
						var r = t;
						this.expectJSX(".");
						var n = this.parseJSXIdentifier();
						t = this.finalize(e, new o.JSXMemberExpression(r, n))
					}
				return t
				...
				if (this.matchJSX(":")) {
					...
					e = this.finalize(t, new o.JSXNamespacedName(s, r))
				} else e = i;
				return e
				...
				var t = this.parseJSXElementName(),
					...
					s = this.matchJSX("/");
				return s && this.expectJSX("/"), this.expectJSX(">"), this.finalize(e, new o.JSXOpeningElement(t, s, i))
				...
				var i = this.parseJSXElementName(),
					...
					r = this.matchJSX("/");
				return r && this.expectJSX("/"), this.expectJSX(">"), this.finalize(e, new o.JSXOpeningElement(i, r, s))
				...
				for (var e = []; !this.scanner.eof();) {
					...
					if (i.start < i.end) {
						var s = this.getTokenRaw(i),
							r = this.finalize(t, new o.JSXText(i.value, s));
						e.push(r)
					}
				...
				return e
			}, e.prototype.parseComplexJSXElement = function(e) {
				for (var t = []; !this.scanner.eof();) {
					...
					if (s.type === h.JSXSyntax.JSXOpeningElement) {
						var r = s;
						if (r.selfClosing) {
							var n = this.finalize(i, new o.JSXElement(r, [], null));
							e.children.push(n)
						} else t.push(e), e = {
							node: i,
							opening: r,
					...
					if (s.type === h.JSXSyntax.JSXClosingElement) {
						e.closing = s;
						var a = p(e.opening.name);
						if (a !== p(e.closing.name) && this.tolerateError("Expected corresponding JSX closing tag for %0", a), !(0 < t.length)) break;
						n = this.finalize(e.node, new o.JSXElement(e.opening, e.children, e.closing));
						(e = t[t.length - 1]).children.push(n), t.pop()
					}
				}
				return e
				...
				return this.finalize(e, new o.JSXElement(t, i, s))
				...
				return s.prototype.isStartOfExpression.call(this) || this.match("<")
			}, e
		}(a.Parser);
		t.JSXParser = d
	}, function(e, t) {
		...
		t.Character = {
			...
			isWhiteSpace: function(e) {
				return 32 === e || 9 === e || 11 === e || 12 === e || 160 === e || 5760 <= e && 0 <= [5760, 8192, 8193, 8194, 8195, 8196, 8197, 8198, 8199, 8200, 8201, 8202, 8239, 8287, 12288, 65279].indexOf(e)
			},
			isLineTerminator: function(e) {
				return 10 === e || 13 === e || 8232 === e || 8233 === e
			},
			isIdentifierStart: function(e) {
				return 36 === e || 95 === e || 65 <= e && e <= 90 || 97 <= e && e <= 122 || 92 === e || 128 <= e && i.NonAsciiIdentifierStart.test(t.Character.fromCodePoint(e))
			},
			isIdentifierPart: function(e) {
				return 36 === e || 95 === e || 65 <= e && e <= 90 || 97 <= e && e <= 122 || 48 <= e && e <= 57 || 92 === e || 128 <= e && i.NonAsciiIdentifierPart.test(t.Character.fromCodePoint(e))
			},
		...
		var a = i(2),
			s = function(e) {
				this.type = a.Syntax.ArrayExpression, this.elements = e
			};
		t.ArrayExpression = s;
		var r = function(e) {
			this.type = a.Syntax.ArrayPattern, this.elements = e
		};
		t.ArrayPattern = r;
		var n = function(e, t, i) {
			this.type = a.Syntax.ArrowFunctionExpression, this.id = null, this.params = e, this.body = t, this.generator = !1, this.expression = i, this.async = !1
		};
		t.ArrowFunctionExpression = n;
		var o = function(e, t, i) {
			this.type = a.Syntax.AssignmentExpression, this.operator = e, this.left = t, this.right = i
		};
		t.AssignmentExpression = o;
		var u = function(e, t) {
			this.type = a.Syntax.AssignmentPattern, this.left = e, this.right = t
		};
		t.AssignmentPattern = u;
		var h = function(e, t, i) {
			this.type = a.Syntax.ArrowFunctionExpression, this.id = null, this.params = e, this.body = t, this.generator = !1, this.expression = i, this.async = !0
		};
		t.AsyncArrowFunctionExpression = h;
		var c = function(e, t, i) {
			this.type = a.Syntax.FunctionDeclaration, this.id = e, this.params = t, this.body = i, this.generator = !1, this.expression = !1, this.async = !0
		};
		t.AsyncFunctionDeclaration = c;
		var l = function(e, t, i) {
			this.type = a.Syntax.FunctionExpression, this.id = e, this.params = t, this.body = i, this.generator = !1, this.expression = !1, this.async = !0
		};
		t.AsyncFunctionExpression = l;
		var p = function(e) {
			this.type = a.Syntax.AwaitExpression, this.argument = e
		};
		t.AwaitExpression = p;
		var d = function(e, t, i) {
			var s = "||" === e || "&&" === e;
			this.type = s ? a.Syntax.LogicalExpression : a.Syntax.BinaryExpression, this.operator = e, this.left = t, this.right = i
		};
		t.BinaryExpression = d;
		var m = function(e) {
			this.type = a.Syntax.BlockStatement, this.body = e
		};
		t.BlockStatement = m;
		var x = function(e) {
			this.type = a.Syntax.BreakStatement, this.label = e
		};
		t.BreakStatement = x;
		var D = function(e, t) {
			this.type = a.Syntax.CallExpression, this.callee = e, this.arguments = t
		};
		t.CallExpression = D;
		var f = function(e, t) {
			this.type = a.Syntax.CatchClause, this.param = e, this.body = t
		};
		t.CatchClause = f;
		var E = function(e) {
			this.type = a.Syntax.ClassBody, this.body = e
		};
		t.ClassBody = E;
		var y = function(e, t, i) {
			this.type = a.Syntax.ClassDeclaration, this.id = e, this.superClass = t, this.body = i
		};
		t.ClassDeclaration = y;
		var C = function(e, t, i) {
			this.type = a.Syntax.ClassExpression, this.id = e, this.superClass = t, this.body = i
		};
		t.ClassExpression = C;
		var A = function(e, t) {
			this.type = a.Syntax.MemberExpression, this.computed = !0, this.object = e, this.property = t
		};
		t.ComputedMemberExpression = A;
		var v = function(e, t, i) {
			this.type = a.Syntax.ConditionalExpression, this.test = e, this.consequent = t, this.alternate = i
		};
		t.ConditionalExpression = v;
		var S = function(e) {
			this.type = a.Syntax.ContinueStatement, this.label = e
		};
		...
		var g = function(e, t) {
			this.type = a.Syntax.ExpressionStatement, this.expression = e, this.directive = t
		};
		t.Directive = g;
		var k = function(e, t) {
			this.type = a.Syntax.DoWhileStatement, this.body = e, this.test = t
		};
		...
		t.EmptyStatement = w;
		var B = function(e) {
			this.type = a.Syntax.ExportAllDeclaration, this.source = e
		};
		t.ExportAllDeclaration = B;
		var b = function(e) {
			this.type = a.Syntax.ExportDefaultDeclaration, this.declaration = e
		};
		t.ExportDefaultDeclaration = b;
		var T = function(e, t, i) {
			this.type = a.Syntax.ExportNamedDeclaration, this.declaration = e, this.specifiers = t, this.source = i
		};
		t.ExportNamedDeclaration = T;
		var N = function(e, t) {
			this.type = a.Syntax.ExportSpecifier, this.exported = t, this.local = e
		};
		t.ExportSpecifier = N;
		var I = function(e) {
			this.type = a.Syntax.ExpressionStatement, this.expression = e
		};
		t.ExpressionStatement = I;
		var M = function(e, t, i) {
			this.type = a.Syntax.ForInStatement, this.left = e, this.right = t, this.body = i, this.each = !1
		};
		t.ForInStatement = M;
		var P = function(e, t, i) {
			this.type = a.Syntax.ForOfStatement, this.left = e, this.right = t, this.body = i
		};
		t.ForOfStatement = P;
		var X = function(e, t, i, s) {
			this.type = a.Syntax.ForStatement, this.init = e, this.test = t, this.update = i, this.body = s
		};
		t.ForStatement = X;
		var J = function(e, t, i, s) {
			this.type = a.Syntax.FunctionDeclaration, this.id = e, this.params = t, this.body = i, this.generator = s, this.expression = !1, this.async = !1
		};
		t.FunctionDeclaration = J;
		var U = function(e, t, i, s) {
			this.type = a.Syntax.FunctionExpression, this.id = e, this.params = t, this.body = i, this.generator = s, this.expression = !1, this.async = !1
		};
		t.FunctionExpression = U;
		var L = function(e) {
			this.type = a.Syntax.Identifier, this.name = e
		};
		t.Identifier = L;
		var z = function(e, t, i) {
			this.type = a.Syntax.IfStatement, this.test = e, this.consequent = t, this.alternate = i
		};
		t.IfStatement = z;
		var O = function(e, t) {
			this.type = a.Syntax.ImportDeclaration, this.specifiers = e, this.source = t
		};
		t.ImportDeclaration = O;
		var R = function(e) {
			this.type = a.Syntax.ImportDefaultSpecifier, this.local = e
		};
		t.ImportDefaultSpecifier = R;
		var K = function(e) {
			this.type = a.Syntax.ImportNamespaceSpecifier, this.local = e
		};
		t.ImportNamespaceSpecifier = K;
		var j = function(e, t) {
			this.type = a.Syntax.ImportSpecifier, this.local = e, this.imported = t
		};
		t.ImportSpecifier = j;
		var H = function(e, t) {
			this.type = a.Syntax.LabeledStatement, this.label = e, this.body = t
		};
		t.LabeledStatement = H;
		var W = function(e, t) {
			this.type = a.Syntax.Literal, this.value = e, this.raw = t
		};
		t.Literal = W;
		var G = function(e, t) {
			this.type = a.Syntax.MetaProperty, this.meta = e, this.property = t
		};
		t.MetaProperty = G;
		var _ = function(e, t, i, s, r) {
			this.type = a.Syntax.MethodDefinition, this.key = e, this.computed = t, this.value = i, this.kind = s, this.static = r
		};
		t.MethodDefinition = _;
		var Y = function(e) {
			this.type = a.Syntax.Program, this.body = e, this.sourceType = "module"
		};
		t.Module = Y;
		var V = function(e, t) {
			this.type = a.Syntax.NewExpression, this.callee = e, this.arguments = t
		};
		t.NewExpression = V;
		var q = function(e) {
			this.type = a.Syntax.ObjectExpression, this.properties = e
		};
		t.ObjectExpression = q;
		var $ = function(e) {
			this.type = a.Syntax.ObjectPattern, this.properties = e
		};
		t.ObjectPattern = $;
		var Z = function(e, t, i, s, r, n) {
			this.type = a.Syntax.Property, this.key = t, this.computed = i, this.value = s, this.kind = e, this.method = r, this.shorthand = n
		};
		t.Property = Z;
		var Q = function(e, t, i, s) {
			this.type = a.Syntax.Literal, this.value = e, this.raw = t, this.regex = {
				pattern: i,
				flags: s
			}
		};
		t.RegexLiteral = Q;
		var ee = function(e) {
			this.type = a.Syntax.RestElement, this.argument = e
		};
		t.RestElement = ee;
		var te = function(e) {
			this.type = a.Syntax.ReturnStatement, this.argument = e
		};
		t.ReturnStatement = te;
		var ie = function(e) {
			this.type = a.Syntax.Program, this.body = e, this.sourceType = "script"
		};
		t.Script = ie;
		var se = function(e) {
			this.type = a.Syntax.SequenceExpression, this.expressions = e
		};
		t.SequenceExpression = se;
		var re = function(e) {
			this.type = a.Syntax.SpreadElement, this.argument = e
		};
		t.SpreadElement = re;
		var ne = function(e, t) {
			this.type = a.Syntax.MemberExpression, this.computed = !1, this.object = e, this.property = t
		};
		...
		t.Super = ae;
		var oe = function(e, t) {
			this.type = a.Syntax.SwitchCase, this.test = e, this.consequent = t
		};
		t.SwitchCase = oe;
		var ue = function(e, t) {
			this.type = a.Syntax.SwitchStatement, this.discriminant = e, this.cases = t
		};
		t.SwitchStatement = ue;
		var he = function(e, t) {
			this.type = a.Syntax.TaggedTemplateExpression, this.tag = e, this.quasi = t
		};
		t.TaggedTemplateExpression = he;
		var ce = function(e, t) {
			this.type = a.Syntax.TemplateElement, this.value = e, this.tail = t
		};
		t.TemplateElement = ce;
		var le = function(e, t) {
			this.type = a.Syntax.TemplateLiteral, this.quasis = e, this.expressions = t
		};
		...
		t.ThisExpression = pe;
		var de = function(e) {
			this.type = a.Syntax.ThrowStatement, this.argument = e
		};
		t.ThrowStatement = de;
		var me = function(e, t, i) {
			this.type = a.Syntax.TryStatement, this.block = e, this.handler = t, this.finalizer = i
		};
		t.TryStatement = me;
		var xe = function(e, t) {
			this.type = a.Syntax.UnaryExpression, this.operator = e, this.argument = t, this.prefix = !0
		};
		t.UnaryExpression = xe;
		var De = function(e, t, i) {
			this.type = a.Syntax.UpdateExpression, this.operator = e, this.argument = t, this.prefix = i
		};
		t.UpdateExpression = De;
		var fe = function(e, t) {
			this.type = a.Syntax.VariableDeclaration, this.declarations = e, this.kind = t
		};
		t.VariableDeclaration = fe;
		var Ee = function(e, t) {
			this.type = a.Syntax.VariableDeclarator, this.id = e, this.init = t
		};
		t.VariableDeclarator = Ee;
		var ye = function(e, t) {
			this.type = a.Syntax.WhileStatement, this.test = e, this.body = t
		};
		t.WhileStatement = ye;
		var Ce = function(e, t) {
			this.type = a.Syntax.WithStatement, this.object = e, this.body = t
		};
		t.WithStatement = Ce;
		var Ae = function(e, t) {
			this.type = a.Syntax.YieldExpression, this.argument = e, this.delegate = t
		};
		...
		var u = i(9),
			...
			a = function() {
				function e(e, t, i) {
					...
					}, this.config.loc && t.source && null !== t.source && (this.config.source = String(t.source)), this.delegate = i, this.errorHandler = new s.ErrorHandler, this.errorHandler.tolerant = this.config.tolerant, this.scanner = new r.Scanner(e, this.errorHandler), this.scanner.trackComment = this.config.comment, this.operatorPrecedence = {
						")": 0,
						";": 0,
						",": 0,
						"=": 0,
				...
				return e.prototype.throwError = function(e) {
					...
					var s = Array.prototype.slice.call(arguments, 1),
						r = e.replace(/%(\d)/g, function(e, t) {
							return u.assert(t < s.length, "Message reference must be in range"), s[t]
						}),
						n = this.lastMarker.index,
						a = this.lastMarker.line,
						o = this.lastMarker.column + 1;
					throw this.errorHandler.createError(n, a, o, r)
					...
					var s = Array.prototype.slice.call(arguments, 1),
						...
						o = this.lastMarker.column + 1;
					this.errorHandler.tolerateError(n, a, o, r)
				}, e.prototype.unexpectedTokenError = function(e, t) {
					var i, s = t || f.Messages.UnexpectedToken;
					if (e ? (t || (s = 2 === e.type ? f.Messages.UnexpectedEOS : 3 === e.type ? f.Messages.UnexpectedIdentifier : 6 === e.type ? f.Messages.UnexpectedNumber : 8 === e.type ? f.Messages.UnexpectedString : 10 === e.type ? f.Messages.UnexpectedTemplate : f.Messages.UnexpectedToken, 4 === e.type && (this.scanner.isFutureReservedWord(e.value) ? s = f.Messages.UnexpectedReserved : this.context.strict && this.scanner.isStrictModeReservedWord(e.value) && (s = f.Messages.StrictReservedWord))), i = e.value) : i = "ILLEGAL", s = s.replace("%0", i), e && "number" == typeof e.lineNumber) {
						var r = e.start,
							n = e.lineNumber,
							a = this.lastMarker.index - this.lastMarker.column,
							o = e.start - a + 1;
						return this.errorHandler.createError(r, n, o, s)
					}
					r = this.lastMarker.index, n = this.lastMarker.line, o = this.lastMarker.column + 1;
					return this.errorHandler.createError(r, n, o, s)
					...
					if (this.config.tolerant) {
						var e = this.lookahead;
						7 === e.type && "," === e.value ? this.nextToken() : 7 === e.type && ";" === e.value ? (this.nextToken(), this.tolerateUnexpectedToken(e)) : this.tolerateUnexpectedToken(e, f.Messages.UnexpectedToken)
					} else this.expect(",")
					...
					var r = e.call(this);
					return null !== this.context.firstCoverInitializedNameError && this.throwUnexpectedToken(this.context.firstCoverInitializedNameError), this.context.isBindingElement = t, this.context.isAssignmentTarget = i, this.context.firstCoverInitializedNameError = s, r
					...
					this.context.isBindingElement = !0, this.context.isAssignmentTarget = !0, this.context.firstCoverInitializedNameError = null;
					var r = e.call(this);
					return this.context.isBindingElement = this.context.isBindingElement && t, this.context.isAssignmentTarget = this.context.isAssignmentTarget && i, this.context.firstCoverInitializedNameError = s || this.context.firstCoverInitializedNameError, r
					...
					switch (this.lookahead.type) {
						case 3:
							(this.context.isModule || this.context.await) && "await" === this.lookahead.value && this.tolerateUnexpectedToken(this.lookahead), e = this.matchAsyncFunction() ? this.parseFunctionExpression() : this.finalize(s, new E.Identifier(this.nextToken().value));
							break;
						case 6:
						case 8:
							this.context.strict && this.lookahead.octal && this.tolerateUnexpectedToken(this.lookahead, f.Messages.StrictOctalLiteral), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new E.Literal(t.value, i));
							break;
						case 1:
							this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new E.Literal("true" === t.value, i));
							break;
						case 5:
							this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, t = this.nextToken(), i = this.getTokenRaw(t), e = this.finalize(s, new E.Literal(null, i));
							break;
						case 10:
						...
						case 7:
							switch (this.lookahead.value) {
								...
								case "/":
								case "/=":
									this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, this.scanner.index = this.startMarker.index, t = this.nextRegexToken(), i = this.getTokenRaw(t), e = this.finalize(s, new E.RegexLiteral(t.regex, i, t.pattern, t.flags));
									break;
								default:
							...
							break;
						case 4:
							!this.context.strict && this.context.allowYield && this.matchKeyword("yield") ? e = this.parseIdentifierName() : !this.context.strict && this.matchKeyword("let") ? e = this.finalize(s, new E.Identifier(this.nextToken().value)) : (this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1, this.matchKeyword("function") ? e = this.parseFunctionExpression() : this.matchKeyword("this") ? (this.nextToken(), e = this.finalize(s, new E.ThisExpression)) : e = this.matchKeyword("class") ? this.parseClassExpression() : this.throwUnexpectedToken(this.nextToken()));
							break;
						default:
							e = this.throwUnexpectedToken(this.nextToken())
					}
					...
					return this.finalize(e, new E.SpreadElement(t))
					...
					return this.expect("]"), this.finalize(e, new E.ArrayExpression(t))
					...
					return this.context.allowYield = t, this.finalize(e, new E.FunctionExpression(null, i.params, s, !1))
					...
					return this.context.allowYield = t, this.context.await = i, this.finalize(e, new E.AsyncFunctionExpression(null, s.params, r))
					...
					switch (i.type) {
						case 8:
						case 6:
							this.context.strict && i.octal && this.tolerateUnexpectedToken(i, f.Messages.StrictOctalLiteral);
							var s = this.getTokenRaw(i);
							e = this.finalize(t, new E.Literal(i.value, s));
							break;
						case 3:
						case 1:
						case 5:
						case 4:
							e = this.finalize(t, new E.Identifier(i.value));
							break;
						case 7:
					...
					return e.type === y.Syntax.Identifier && e.name === t || e.type === y.Syntax.Literal && e.value === t
					...
					if (3 === s.type) {
						var c = s.value;
						this.nextToken(), a = this.match("["), r = (h = !(this.hasLineTerminator || "async" !== c || this.match(":") || this.match("(") || this.match("*") || this.match(","))) ? this.parseObjectPropertyKey() : this.finalize(i, new E.Identifier(c))
					} else this.match("*") ? this.nextToken() : (a = this.match("["), r = this.parseObjectPropertyKey());
					var l = this.qualifiedPropertyName(this.lookahead);
					if (3 === s.type && !h && "get" === s.value && l) t = "get", a = this.match("["), r = this.parseObjectPropertyKey(), this.context.allowYield = !1, n = this.parseGetterMethod();
					else if (3 === s.type && !h && "set" === s.value && l) t = "set", a = this.match("["), r = this.parseObjectPropertyKey(), n = this.parseSetterMethod();
					else if (7 === s.type && "*" === s.value && l) t = "init", a = this.match("["), r = this.parseObjectPropertyKey(), n = this.parseGeneratorMethod(), o = !0;
					else if (r || this.throwUnexpectedToken(this.lookahead), t = "init", this.match(":") && !h) !a && this.isPropertyKey(r, "__proto__") && (e.value && this.tolerateError(f.Messages.DuplicateProtoProperty), e.value = !0), this.nextToken(), n = this.inheritCoverGrammar(this.parseAssignmentExpression);
					else if (this.match("(")) n = h ? this.parsePropertyMethodAsyncFunction() : this.parsePropertyMethodFunction(), o = !0;
					else if (3 === s.type) {
						c = this.finalize(i, new E.Identifier(s.value));
						if (this.match("=")) {
							...
							n = this.finalize(i, new E.AssignmentPattern(c, p))
						} else u = !0, n = c
					} else this.throwUnexpectedToken(this.nextToken());
					return this.finalize(i, new E.Property(t, r, a, n, o, u))
					...
					return this.expect("}"), this.finalize(e, new E.ObjectExpression(t))
					...
					var e = this.createNode(),
						...
						i = t.value,
						s = t.cooked;
					return this.finalize(e, new E.TemplateElement({
						raw: i,
						cooked: s
					}, t.tail))
					...
					for (i.push(s); !s.tail;) t.push(this.parseExpression()), s = this.parseTemplateElement(), i.push(s);
					return this.finalize(e, new E.TemplateLiteral(i, t))
				}, e.prototype.reinterpretExpressionAsPattern = function(e) {
					switch (e.type) {
						case y.Syntax.Identifier:
						case y.Syntax.MemberExpression:
						case y.Syntax.RestElement:
						case y.Syntax.AssignmentPattern:
							break;
						case y.Syntax.SpreadElement:
							e.type = y.Syntax.RestElement, this.reinterpretExpressionAsPattern(e.argument);
							break;
						case y.Syntax.ArrayExpression:
							e.type = y.Syntax.ArrayPattern;
							for (var t = 0; t < e.elements.length; t++) null !== e.elements[t] && this.reinterpretExpressionAsPattern(e.elements[t]);
							break;
						case y.Syntax.ObjectExpression:
							e.type = y.Syntax.ObjectPattern;
							for (t = 0; t < e.properties.length; t++) this.reinterpretExpressionAsPattern(e.properties[t].value);
							break;
						case y.Syntax.AssignmentExpression:
							e.type = y.Syntax.AssignmentPattern, delete e.operator, this.reinterpretExpressionAsPattern(e.left)
					}
							...
							if (this.context.isBindingElement = !0, e = this.inheritCoverGrammar(this.parseAssignmentExpression), this.match(",")) {
								...
								for (this.context.isAssignmentTarget = !1, r.push(e); 2 !== this.lookahead.type && this.match(",");) {
									if (this.nextToken(), this.match(")")) {
										this.nextToken();
										for (var n = 0; n < r.length; n++) this.reinterpretExpressionAsPattern(r[n]);
										e = {
											type: C,
											params: r,
											async: !(s = !0)
										...
										for (n = 0; n < r.length; n++) this.reinterpretExpressionAsPattern(r[n]);
										e = {
											type: C,
											params: r,
											async: !(s = !0)
								...
								s || (e = this.finalize(this.startNode(t), new E.SequenceExpression(r)))
							}
							if (!s) {
								if (this.expect(")"), this.match("=>") && (e.type === y.Syntax.Identifier && "yield" === e.name && (e = {
										type: C,
										params: [e],
										async: !(s = !0)
									}), !s)) {
									if (this.context.isBindingElement || this.throwUnexpectedToken(this.lookahead), e.type === y.Syntax.SequenceExpression)
										for (n = 0; n < e.expressions.length; n++) this.reinterpretExpressionAsPattern(e.expressions[n]);
									else this.reinterpretExpressionAsPattern(e);
									var a = e.type === y.Syntax.SequenceExpression ? e.expressions : [e];
									e = {
										type: C,
										params: a,
										async: !1
					...
					var e = this.createNode(),
						t = this.nextToken();
					return this.isIdentifierName(t) || this.throwUnexpectedToken(t), this.finalize(e, new E.Identifier(t.value))
				}, e.prototype.parseNewExpression = function() {
					var e, t = this.createNode(),
						i = this.parseIdentifierName();
					if (u.assert("new" === i.name, "New expression must start with `new`"), this.match("."))
						if (this.nextToken(), 3 === this.lookahead.type && this.context.inFunctionBody && "target" === this.lookahead.value) {
							...
							e = new E.MetaProperty(i, s)
						} else this.throwUnexpectedToken(this.lookahead);
					else {
						var r = this.isolateCoverGrammar(this.parseLeftHandSideExpression),
							n = this.match("(") ? this.parseArguments() : [];
						e = new E.NewExpression(r, n), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
					}
					...
					for (this.context.allowIn = !0, this.matchKeyword("super") && this.context.inFunctionBody ? (e = this.createNode(), this.nextToken(), e = this.finalize(e, new E.Super), this.match("(") || this.match(".") || this.match("[") || this.throwUnexpectedToken(this.lookahead)) : e = this.inheritCoverGrammar(this.matchKeyword("new") ? this.parseNewExpression : this.parsePrimaryExpression);;)
						if (this.match(".")) {
							...
							e = this.finalize(this.startNode(t), new E.StaticMemberExpression(e, r))
						} else if (this.match("(")) {
						...
						if (e = this.finalize(this.startNode(t), new E.CallExpression(e, a)), n && this.match("=>")) {
							for (var o = 0; o < a.length; ++o) this.reinterpretExpressionAsPattern(a[o]);
							e = {
								type: C,
								params: a,
								async: !0
						...
						this.expect("]"), e = this.finalize(this.startNode(t), new E.ComputedMemberExpression(e, r))
					} else {
						if (10 !== this.lookahead.type || !this.lookahead.head) break;
						var u = this.parseTemplateLiteral();
						e = this.finalize(this.startNode(t), new E.TaggedTemplateExpression(e, u))
					}
					return this.context.allowIn = s, e
				}, e.prototype.parseSuper = function() {
					var e = this.createNode();
					return this.expectKeyword("super"), this.match("[") || this.match(".") || this.throwUnexpectedToken(this.lookahead), this.finalize(e, new E.Super)
					...
					for (var e = this.startNode(this.lookahead), t = this.matchKeyword("super") && this.context.inFunctionBody ? this.parseSuper() : this.inheritCoverGrammar(this.matchKeyword("new") ? this.parseNewExpression : this.parsePrimaryExpression);;)
						if (this.match("[")) {
							...
							this.expect("]"), t = this.finalize(e, new E.ComputedMemberExpression(t, i))
						} else if (this.match(".")) {
						this.context.isBindingElement = !1, this.context.isAssignmentTarget = !0, this.expect(".");
						i = this.parseIdentifierName();
						t = this.finalize(e, new E.StaticMemberExpression(t, i))
					} else {
						if (10 !== this.lookahead.type || !this.lookahead.head) break;
						var s = this.parseTemplateLiteral();
						t = this.finalize(e, new E.TaggedTemplateExpression(t, s))
					}
					return t
					...
					if (this.match("++") || this.match("--")) {
						var i = this.startNode(t),
							s = this.nextToken();
						e = this.inheritCoverGrammar(this.parseUnaryExpression), this.context.strict && e.type === y.Syntax.Identifier && this.scanner.isRestrictedWord(e.name) && this.tolerateError(f.Messages.StrictLHSPrefix), this.context.isAssignmentTarget || this.tolerateError(f.Messages.InvalidLHSInAssignment);
						var r = !0;
						e = this.finalize(i, new E.UpdateExpression(s.value, e, r)), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
						...
						this.context.strict && e.type === y.Syntax.Identifier && this.scanner.isRestrictedWord(e.name) && this.tolerateError(f.Messages.StrictLHSPostfix), this.context.isAssignmentTarget || this.tolerateError(f.Messages.InvalidLHSInAssignment), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1;
						var n = this.nextToken().value;
						r = !1;
						e = this.finalize(this.startNode(t), new E.UpdateExpression(n, e, r))
					}
					return e
					...
					return this.finalize(e, new E.AwaitExpression(t))
				}, e.prototype.parseUnaryExpression = function() {
					var e;
					if (this.match("+") || this.match("-") || this.match("~") || this.match("!") || this.matchKeyword("delete") || this.matchKeyword("void") || this.matchKeyword("typeof")) {
						var t = this.startNode(this.lookahead),
							i = this.nextToken();
						e = this.inheritCoverGrammar(this.parseUnaryExpression), e = this.finalize(t, new E.UnaryExpression(i.value, e)), this.context.strict && "delete" === e.operator && e.argument.type === y.Syntax.Identifier && this.tolerateError(f.Messages.StrictDelete), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
					...
					if (t.type !== y.Syntax.UnaryExpression && this.match("**")) {
						...
						t = this.finalize(this.startNode(e), new E.BinaryExpression("**", i, s))
					}
					return t
					...
					if (0 < s) {
						this.nextToken(), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1;
						for (var r = [e, this.lookahead], n = t, a = this.isolateCoverGrammar(this.parseExponentiationExpression), o = [n, i.value, a], u = [s]; !((s = this.binaryPrecedence(this.lookahead)) <= 0);) {
							for (; 2 < o.length && s <= u[u.length - 1];) {
								a = o.pop();
								var h = o.pop();
								u.pop(), n = o.pop(), r.pop();
								var c = this.startNode(r[r.length - 1]);
								o.push(this.finalize(c, new E.BinaryExpression(h, n, a)))
							}
							o.push(this.nextToken().value), u.push(s), r.push(this.lookahead), o.push(this.isolateCoverGrammar(this.parseExponentiationExpression))
						}
						var l = o.length - 1;
						t = o[l];
						for (var p = r.pop(); 1 < l;) {
							var d = r.pop(),
								m = p && p.lineStart;
							c = this.startNode(d, m), h = o[l - 1];
							t = this.finalize(c, new E.BinaryExpression(h, o[l - 2], t)), l -= 2, p = d
						}
					}
					return t
					...
					if (this.match("?")) {
						...
						t = this.finalize(this.startNode(e), new E.ConditionalExpression(t, s, r)), this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1
					}
					return t
					...
					if (!this.context.allowYield && this.matchKeyword("yield")) e = this.parseYieldExpression();
						...
						if (e.type === C || this.match("=>")) {
							this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1;
							var r = e.async,
								n = this.reinterpretAsCoverFormalsList(e);
							if (n) {
								...
								var a = this.context.strict,
									o = this.context.allowStrictDirective;
								this.context.allowStrictDirective = n.simple;
								var u = this.context.allowYield,
									h = this.context.await;
								this.context.allowYield = !0, this.context.await = r;
								var c = this.startNode(t);
								this.expect("=>");
								var l = void 0;
								if (this.match("{")) {
									var p = this.context.allowIn;
									this.context.allowIn = !0, l = this.parseFunctionSourceElements(), this.context.allowIn = p
								} else l = this.isolateCoverGrammar(this.parseAssignmentExpression);
								var d = l.type !== y.Syntax.BlockStatement;
								this.context.strict && n.firstRestricted && this.throwUnexpectedToken(n.firstRestricted, n.message), this.context.strict && n.stricted && this.tolerateUnexpectedToken(n.stricted, n.message), e = r ? this.finalize(c, new E.AsyncArrowFunctionExpression(n.params, l, d)) : this.finalize(c, new E.ArrowFunctionExpression(n.params, l, d)), this.context.strict = a, this.context.allowStrictDirective = o, this.context.allowYield = u, this.context.await = h
							}
						} else if (this.matchAssign()) {
							if (this.context.isAssignmentTarget || this.tolerateError(f.Messages.InvalidLHSInAssignment), this.context.strict && e.type === y.Syntax.Identifier) {
								var m = e;
								this.scanner.isRestrictedWord(m.name) && this.tolerateUnexpectedToken(i, f.Messages.StrictLHSAssignment), this.scanner.isStrictModeReservedWord(m.name) && this.tolerateUnexpectedToken(i, f.Messages.StrictReservedWord)
							}
							this.match("=") ? this.reinterpretExpressionAsPattern(e) : (this.context.isAssignmentTarget = !1, this.context.isBindingElement = !1);
							var x = (i = this.nextToken()).value,
								D = this.isolateCoverGrammar(this.parseAssignmentExpression);
							e = this.finalize(this.startNode(t), new E.AssignmentExpression(x, e, D)), this.context.firstCoverInitializedNameError = null
						}
					}
					return e
					...
					if (this.match(",")) {
						...
						t = this.finalize(this.startNode(e), new E.SequenceExpression(i))
					}
					return t
					...
					if (this.context.isAssignmentTarget = !0, this.context.isBindingElement = !0, 4 === this.lookahead.type) switch (this.lookahead.value) {
						case "export":
							this.context.isModule || this.tolerateUnexpectedToken(this.lookahead, f.Messages.IllegalExportDeclaration), e = this.parseExportDeclaration();
							break;
						case "import":
							this.context.isModule || this.tolerateUnexpectedToken(this.lookahead, f.Messages.IllegalImportDeclaration), e = this.parseImportDeclaration();
							break;
						case "const":
					...
					return this.expect("}"), this.finalize(e, new E.BlockStatement(t))
				}, e.prototype.parseLexicalBinding = function(e, t) {
					var i = this.createNode(),
						s = this.parsePattern([], e);
					this.context.strict && s.type === y.Syntax.Identifier && this.scanner.isRestrictedWord(s.name) && this.tolerateError(f.Messages.StrictVarName);
					var r = null;
					return "const" === e ? this.matchKeyword("in") || this.matchContextualKeyword("of") || (this.match("=") ? (this.nextToken(), r = this.isolateCoverGrammar(this.parseAssignmentExpression)) : this.throwError(f.Messages.DeclarationMissingInitializer, "const")) : (!t.inFor && s.type !== y.Syntax.Identifier || this.match("=")) && (this.expect("="), r = this.isolateCoverGrammar(this.parseAssignmentExpression)), this.finalize(i, new E.VariableDeclarator(s, r))
					...
					u.assert("let" === i || "const" === i, "Lexical declaration must be either let or const");
					var s = this.parseBindingList(i, e);
					return this.consumeSemicolon(), this.finalize(t, new E.VariableDeclaration(s, i))
				}, e.prototype.parseBindingRestElement = function(e, t) {
					var i = this.createNode();
					this.expect("...");
					var s = this.parsePattern(e, t);
					return this.finalize(i, new E.RestElement(s))
					...
					for (var s = []; !this.match("]");)
						...
						} return this.expect("]"), this.finalize(i, new E.ArrayPattern(s))
				}, e.prototype.parsePropertyPattern = function(e, t) {
					var i, s, r = this.createNode(),
						n = !1,
						a = !1;
					if (3 === this.lookahead.type) {
						var o = this.lookahead;
						i = this.parseVariableIdentifier();
						var u = this.finalize(r, new E.Identifier(o.value));
						if (this.match("=")) {
							e.push(o), a = !0, this.nextToken();
							var h = this.parseAssignmentExpression();
							s = this.finalize(this.startNode(o), new E.AssignmentPattern(u, h))
						} else this.match(":") ? (this.expect(":"), s = this.parsePatternWithDefault(e, t)) : (e.push(o), a = !0, s = u)
					} else n = this.match("["), i = this.parseObjectPropertyKey(), this.expect(":"), s = this.parsePatternWithDefault(e, t);
					return this.finalize(r, new E.Property("init", i, n, s, !1, a))
				}, e.prototype.parseObjectPattern = function(e, t) {
					var i = this.createNode(),
						s = [];
					for (this.expect("{"); !this.match("}");) s.push(this.parsePropertyPattern(e, t)), this.match("}") || this.expect(",");
					return this.expect("}"), this.finalize(i, new E.ObjectPattern(s))
				}, e.prototype.parsePattern = function(e, t) {
					var i;
					return this.match("[") ? i = this.parseArrayPattern(e, t) : this.match("{") ? i = this.parseObjectPattern(e, t) : (!this.matchKeyword("let") || "const" !== t && "let" !== t || this.tolerateUnexpectedToken(this.lookahead, f.Messages.LetInLexicalBinding), e.push(this.lookahead), i = this.parseVariableIdentifier(t)), i
					...
					if (this.match("=")) {
						...
						this.context.allowYield = r, s = this.finalize(this.startNode(i), new E.AssignmentPattern(s, n))
					}
					return s
				}, e.prototype.parseVariableIdentifier = function(e) {
					var t = this.createNode(),
						i = this.nextToken();
					return 4 === i.type && "yield" === i.value ? this.context.strict ? this.tolerateUnexpectedToken(i, f.Messages.StrictReservedWord) : this.context.allowYield || this.throwUnexpectedToken(i) : 3 !== i.type ? this.context.strict && 4 === i.type && this.scanner.isStrictModeReservedWord(i.value) ? this.tolerateUnexpectedToken(i, f.Messages.StrictReservedWord) : (this.context.strict || "let" !== i.value || "var" !== e) && this.throwUnexpectedToken(i) : (this.context.isModule || this.context.await) && 3 === i.type && "await" === i.value && this.tolerateUnexpectedToken(i), this.finalize(t, new E.Identifier(i.value))
				}, e.prototype.parseVariableDeclaration = function(e) {
					var t = this.createNode(),
						i = this.parsePattern([], "var");
					this.context.strict && i.type === y.Syntax.Identifier && this.scanner.isRestrictedWord(i.name) && this.tolerateError(f.Messages.StrictVarName);
					var s = null;
					return this.match("=") ? (this.nextToken(), s = this.isolateCoverGrammar(this.parseAssignmentExpression)) : i.type === y.Syntax.Identifier || e.inFor || this.expect("="), this.finalize(t, new E.VariableDeclarator(i, s))
					...
					return this.consumeSemicolon(), this.finalize(e, new E.VariableDeclaration(t, "var"))
				}, e.prototype.parseEmptyStatement = function() {
					var e = this.createNode();
					return this.expect(";"), this.finalize(e, new E.EmptyStatement)
				}, e.prototype.parseExpressionStatement = function() {
					var e = this.createNode(),
						t = this.parseExpression();
					return this.consumeSemicolon(), this.finalize(e, new E.ExpressionStatement(t))
				}, e.prototype.parseIfClause = function() {
					return this.context.strict && this.matchKeyword("function") && this.tolerateError(f.Messages.StrictFunction), this.parseStatement()
				}, e.prototype.parseIfStatement = function() {
					var e, t = this.createNode(),
						i = null;
					this.expectKeyword("if"), this.expect("(");
					var s = this.parseExpression();
					return !this.match(")") && this.config.tolerant ? (this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new E.EmptyStatement)) : (this.expect(")"), e = this.parseIfClause(), this.matchKeyword("else") && (this.nextToken(), i = this.parseIfClause())), this.finalize(t, new E.IfStatement(s, e, i))
					...
					var s = this.parseExpression();
					return !this.match(")") && this.config.tolerant ? this.tolerateUnexpectedToken(this.nextToken()) : (this.expect(")"), this.match(";") && this.nextToken()), this.finalize(e, new E.DoWhileStatement(i, s))
				}, e.prototype.parseWhileStatement = function() {
					var e, t = this.createNode();
					this.expectKeyword("while"), this.expect("(");
					var i = this.parseExpression();
					if (!this.match(")") && this.config.tolerant) this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new E.EmptyStatement);
					else {
						this.expect(")");
						var s = this.context.inIteration;
						this.context.inIteration = !0, e = this.parseStatement(), this.context.inIteration = s
					}
					return this.finalize(t, new E.WhileStatement(i, e))
					...
					if (this.expectKeyword("for"), this.expect("("), this.match(";")) this.nextToken();
						...
						if (this.context.allowIn = u, 1 === h.length && this.matchKeyword("in")) {
							var c = h[0];
							c.init && (c.id.type === y.Syntax.ArrayPattern || c.id.type === y.Syntax.ObjectPattern || this.context.strict) && this.tolerateError(f.Messages.ForInOfLoopInitializer, "for-in"), s = this.finalize(s, new E.VariableDeclaration(h, "var")), this.nextToken(), e = s, t = this.parseExpression(), s = null
						} else 1 === h.length && null === h[0].init && this.matchContextualKeyword("of") ? (s = this.finalize(s, new E.VariableDeclaration(h, "var")), this.nextToken(), e = s, t = this.parseAssignmentExpression(), s = null, a = !1) : (s = this.finalize(s, new E.VariableDeclaration(h, "var")), this.expect(";"))
						...
						if (this.context.strict || "in" !== this.lookahead.value) {
							...
							this.context.allowIn = !1;
							h = this.parseBindingList(l, {
								inFor: !0
							});
							this.context.allowIn = u, 1 === h.length && null === h[0].init && this.matchKeyword("in") ? (s = this.finalize(s, new E.VariableDeclaration(h, l)), this.nextToken(), e = s, t = this.parseExpression(), s = null) : 1 === h.length && null === h[0].init && this.matchContextualKeyword("of") ? (s = this.finalize(s, new E.VariableDeclaration(h, l)), this.nextToken(), e = s, t = this.parseAssignmentExpression(), s = null, a = !1) : (this.consumeSemicolon(), s = this.finalize(s, new E.VariableDeclaration(h, l)))
						} else s = this.finalize(s, new E.Identifier(l)), this.nextToken(), e = s, t = this.parseExpression(), s = null
					} else {
						var p = this.lookahead;
						u = this.context.allowIn;
						if (this.context.allowIn = !1, s = this.inheritCoverGrammar(this.parseAssignmentExpression), this.context.allowIn = u, this.matchKeyword("in")) this.context.isAssignmentTarget && s.type !== y.Syntax.AssignmentExpression || this.tolerateError(f.Messages.InvalidLHSInForIn), this.nextToken(), this.reinterpretExpressionAsPattern(s), e = s, t = this.parseExpression(), s = null;
						else if (this.matchContextualKeyword("of")) this.context.isAssignmentTarget && s.type !== y.Syntax.AssignmentExpression || this.tolerateError(f.Messages.InvalidLHSInForLoop), this.nextToken(), this.reinterpretExpressionAsPattern(s), e = s, t = this.parseAssignmentExpression(), s = null, a = !1;
						else {
							if (this.match(",")) {
								for (var d = [s]; this.match(",");) this.nextToken(), d.push(this.isolateCoverGrammar(this.parseAssignmentExpression));
								s = this.finalize(this.startNode(p), new E.SequenceExpression(d))
							}
							this.expect(";")
						}
					}
					if (void 0 === e && (this.match(";") || (r = this.parseExpression()), this.expect(";"), this.match(")") || (n = this.parseExpression())), !this.match(")") && this.config.tolerant) this.tolerateUnexpectedToken(this.nextToken()), i = this.finalize(this.createNode(), new E.EmptyStatement);
					else {
						this.expect(")");
						var m = this.context.inIteration;
						this.context.inIteration = !0, i = this.isolateCoverGrammar(this.parseStatement), this.context.inIteration = m
					}
					return void 0 === e ? this.finalize(o, new E.ForStatement(s, r, n, i)) : a ? this.finalize(o, new E.ForInStatement(e, t, i)) : this.finalize(o, new E.ForOfStatement(e, t, i))
					...
					if (3 === this.lookahead.type && !this.hasLineTerminator) {
						var i = this.parseVariableIdentifier(),
							s = "$" + (t = i).name;
						Object.prototype.hasOwnProperty.call(this.context.labelSet, s) || this.throwError(f.Messages.UnknownLabel, i.name)
					}
					return this.consumeSemicolon(), null !== t || this.context.inIteration || this.throwError(f.Messages.IllegalContinue), this.finalize(e, new E.ContinueStatement(t))
					...
					if (3 === this.lookahead.type && !this.hasLineTerminator) {
						var i = this.parseVariableIdentifier(),
							s = "$" + i.name;
						Object.prototype.hasOwnProperty.call(this.context.labelSet, s) || this.throwError(f.Messages.UnknownLabel, i.name), t = i
					}
					return this.consumeSemicolon(), null !== t || this.context.inIteration || this.context.inSwitch || this.throwError(f.Messages.IllegalBreak), this.finalize(e, new E.BreakStatement(t))
					...
					return this.consumeSemicolon(), this.finalize(e, new E.ReturnStatement(t))
					...
					var i = this.parseExpression();
					return !this.match(")") && this.config.tolerant ? (this.tolerateUnexpectedToken(this.nextToken()), e = this.finalize(this.createNode(), new E.EmptyStatement)) : (this.expect(")"), e = this.parseStatement()), this.finalize(t, new E.WithStatement(i, e))
					...
					return this.finalize(t, new E.SwitchCase(e, i))
					...
					var i = this.context.inSwitch,
						s = [],
						r = !(this.context.inSwitch = !0);
					for (this.expect("{"); !this.match("}");) {
						var n = this.parseSwitchCase();
						null === n.test && (r && this.throwError(f.Messages.MultipleDefaultsInSwitch), r = !0), s.push(n)
					}
					return this.expect("}"), this.context.inSwitch = i, this.finalize(e, new E.SwitchStatement(t, s))
				}, e.prototype.parseLabelledStatement = function() {
					var e, t = this.createNode(),
						i = this.parseExpression();
					if (i.type === y.Syntax.Identifier && this.match(":")) {
						this.nextToken();
						var s = i,
							r = "$" + s.name;
						Object.prototype.hasOwnProperty.call(this.context.labelSet, r) && this.throwError(f.Messages.Redeclaration, "Label", s.name), this.context.labelSet[r] = !0;
						var n = void 0;
						if (this.matchKeyword("class")) this.tolerateUnexpectedToken(this.lookahead), n = this.parseClassDeclaration();
						else if (this.matchKeyword("function")) {
							var a = this.lookahead,
								o = this.parseFunctionDeclaration();
							this.context.strict ? this.tolerateUnexpectedToken(a, f.Messages.StrictFunction) : o.generator && this.tolerateUnexpectedToken(a, f.Messages.GeneratorInLegacyContext), n = o
						} else n = this.parseStatement();
						delete this.context.labelSet[r], e = new E.LabeledStatement(s, n)
					} else this.consumeSemicolon(), e = new E.ExpressionStatement(i);
					return this.finalize(t, e)
				}, e.prototype.parseThrowStatement = function() {
					var e = this.createNode();
					this.expectKeyword("throw"), this.hasLineTerminator && this.throwError(f.Messages.NewlineAfterThrow);
					var t = this.parseExpression();
					return this.consumeSemicolon(), this.finalize(e, new E.ThrowStatement(t))
					...
					for (var t = [], i = this.parsePattern(t), s = {}, r = 0; r < t.length; r++) {
						var n = "$" + t[r].value;
						Object.prototype.hasOwnProperty.call(s, n) && this.tolerateError(f.Messages.DuplicateBinding, t[r].value), s[n] = !0
					}
					this.context.strict && i.type === y.Syntax.Identifier && this.scanner.isRestrictedWord(i.name) && this.tolerateError(f.Messages.StrictCatchVariable), this.expect(")");
					var a = this.parseBlock();
					return this.finalize(e, new E.CatchClause(i, a))
					...
					return i || s || this.throwError(f.Messages.NoCatchOrFinally), this.finalize(e, new E.TryStatement(t, i, s))
				}, e.prototype.parseDebuggerStatement = function() {
					var e = this.createNode();
					return this.expectKeyword("debugger"), this.consumeSemicolon(), this.finalize(e, new E.DebuggerStatement)
					...
					return this.match("=") && this.throwError(f.Messages.DefaultRestParameter), this.match(")") || this.throwError(f.Messages.ParameterAfterRestParameter), this.finalize(t, new E.RestElement(i))
					...
					e.simple = e.simple && i instanceof E.Identifier, e.params.push(i)
					...
					if (!e || !this.match("(")) {
						var o = this.lookahead;
						n = this.parseVariableIdentifier(), this.context.strict ? this.scanner.isRestrictedWord(o.value) && this.tolerateUnexpectedToken(o, f.Messages.StrictFunctionName) : this.scanner.isRestrictedWord(o.value) ? (a = o, s = f.Messages.StrictFunctionName) : this.scanner.isStrictModeReservedWord(o.value) && (a = o, s = f.Messages.StrictReservedWord)
					}
					var u = this.context.await,
						h = this.context.allowYield;
					this.context.await = i, this.context.allowYield = !r;
					var c = this.parseFormalParameters(a),
						l = c.params,
						p = c.stricted;
					a = c.firstRestricted, c.message && (s = c.message);
					...
					return this.context.strict && a && this.throwUnexpectedToken(a, s), this.context.strict && p && this.tolerateUnexpectedToken(p, s), this.context.strict = d, this.context.allowStrictDirective = m, this.context.await = u, this.context.allowYield = h, i ? this.finalize(t, new E.AsyncFunctionDeclaration(n, l, x)) : this.finalize(t, new E.FunctionDeclaration(n, l, x, r))
					...
					if (this.context.await = t, this.context.allowYield = !s, !this.match("(")) {
						...
						n = this.context.strict || s || !this.matchKeyword("yield") ? this.parseVariableIdentifier() : this.parseIdentifierName(), this.context.strict ? this.scanner.isRestrictedWord(u.value) && this.tolerateUnexpectedToken(u, f.Messages.StrictFunctionName) : this.scanner.isRestrictedWord(u.value) ? (r = u, i = f.Messages.StrictFunctionName) : this.scanner.isStrictModeReservedWord(u.value) && (r = u, i = f.Messages.StrictReservedWord)
					}
					var h = this.parseFormalParameters(r),
						c = h.params,
						l = h.stricted;
					r = h.firstRestricted, h.message && (i = h.message);
					...
					return this.context.strict && r && this.throwUnexpectedToken(r, i), this.context.strict && l && this.tolerateUnexpectedToken(l, i), this.context.strict = p, this.context.allowStrictDirective = d, this.context.await = a, this.context.allowYield = o, t ? this.finalize(e, new E.AsyncFunctionExpression(n, c, m)) : this.finalize(e, new E.FunctionExpression(n, c, m, s))
				}, e.prototype.parseDirective = function() {
					var e = this.lookahead,
						t = this.createNode(),
						i = this.parseExpression(),
						s = i.type === y.Syntax.Literal ? this.getTokenRaw(e).slice(1, -1) : null;
					return this.consumeSemicolon(), this.finalize(t, s ? new E.Directive(i, s) : new E.ExpressionStatement(i))
					...
					for (var e = null, t = [];;) {
						...
						"use strict" === r ? (this.context.strict = !0, e && this.tolerateUnexpectedToken(e, f.Messages.StrictOctalLiteral), this.context.allowStrictDirective || this.tolerateUnexpectedToken(i, f.Messages.IllegalLanguageModeDirective)) : !e && i.octal && (e = i)
					}
					return t
					...
					this.context.allowYield = !0;
					var i = this.parseFormalParameters();
					0 < i.params.length && this.tolerateError(f.Messages.BadGetterArity);
					...
					this.context.allowYield = !0;
					var i = this.parseFormalParameters();
					1 !== i.params.length ? this.tolerateError(f.Messages.BadSetterArity) : i.params[0] instanceof E.RestElement && this.tolerateError(f.Messages.BadSetterRestParameter);
					var s = this.parsePropertyMethod(i);
					return this.context.allowYield = t, this.finalize(e, new E.FunctionExpression(null, i.params, s, !1))
					...
					var s = this.parsePropertyMethod(i);
					return this.context.allowYield = t, this.finalize(e, new E.FunctionExpression(null, i.params, s, !0))
				}, e.prototype.isStartOfExpression = function() {
					var e = !0,
					...
					if (!this.hasLineTerminator) {
						...
						this.context.allowYield = !1, (i = this.match("*")) ? (this.nextToken(), t = this.parseAssignmentExpression()) : this.isStartOfExpression() && (t = this.parseAssignmentExpression()), this.context.allowYield = s
					}
					return this.finalize(e, new E.YieldExpression(t, i))
					...
					else if (a = this.match("["), "static" === (r = this.parseObjectPropertyKey()).name && (this.qualifiedPropertyName(this.lookahead) || this.match("*")) && (t = this.lookahead, u = !0, a = this.match("["), this.match("*") ? this.nextToken() : r = this.parseObjectPropertyKey()), 3 === t.type && !this.hasLineTerminator && "async" === t.value) {
						var c = this.lookahead.value;
						":" !== c && "(" !== c && "*" !== c && (h = !0, t = this.lookahead, r = this.parseObjectPropertyKey(), 3 === t.type && "constructor" === t.value && this.tolerateUnexpectedToken(t, f.Messages.ConstructorIsAsync))
					}
					var l = this.qualifiedPropertyName(this.lookahead);
					return 3 === t.type ? "get" === t.value && l ? (s = "get", a = this.match("["), r = this.parseObjectPropertyKey(), this.context.allowYield = !1, n = this.parseGetterMethod()) : "set" === t.value && l && (s = "set", a = this.match("["), r = this.parseObjectPropertyKey(), n = this.parseSetterMethod()) : 7 === t.type && "*" === t.value && l && (s = "init", a = this.match("["), r = this.parseObjectPropertyKey(), n = this.parseGeneratorMethod(), o = !0), !s && r && this.match("(") && (s = "init", n = h ? this.parsePropertyMethodAsyncFunction() : this.parsePropertyMethodFunction(), o = !0), s || this.throwUnexpectedToken(this.lookahead), "init" === s && (s = "method"), a || (u && this.isPropertyKey(r, "prototype") && this.throwUnexpectedToken(t, f.Messages.StaticPrototype), !u && this.isPropertyKey(r, "constructor") && (("method" !== s || !o || n && n.generator) && this.throwUnexpectedToken(t, f.Messages.ConstructorSpecialMethod), e.value ? this.throwUnexpectedToken(t, f.Messages.DuplicateConstructor) : e.value = !0, s = "constructor")), this.finalize(i, new E.MethodDefinition(r, a, n, s, u))
					...
					return this.finalize(e, new E.ClassBody(t))
					...
					return this.context.strict = i, this.finalize(t, new E.ClassDeclaration(s, r, n))
					...
					return this.context.strict = t, this.finalize(e, new E.ClassExpression(i, s, r))
					...
					return this.finalize(e, new E.Module(t))
				}, e.prototype.parseScript = function() {
					for (var e = this.createNode(), t = this.parseDirectivePrologues(); 2 !== this.lookahead.type;) t.push(this.parseStatementListItem());
					return this.finalize(e, new E.Script(t))
					...
					return this.finalize(e, new E.Literal(t.value, i))
				}, e.prototype.parseImportSpecifier = function() {
					var e, t, i = this.createNode();
					return 3 === this.lookahead.type ? (t = e = this.parseVariableIdentifier(), this.matchContextualKeyword("as") && (this.nextToken(), t = this.parseVariableIdentifier())) : (t = e = this.parseIdentifierName(), this.matchContextualKeyword("as") ? (this.nextToken(), t = this.parseVariableIdentifier()) : this.throwUnexpectedToken(this.nextToken())), this.finalize(i, new E.ImportSpecifier(t, e))
					...
					return this.finalize(e, new E.ImportDefaultSpecifier(t))
				}, e.prototype.parseImportNamespaceSpecifier = function() {
					var e = this.createNode();
					this.expect("*"), this.matchContextualKeyword("as") || this.throwError(f.Messages.NoAsAfterImportNamespace), this.nextToken();
					var t = this.parseIdentifierName();
					return this.finalize(e, new E.ImportNamespaceSpecifier(t))
					...
					if (8 === this.lookahead.type) e = this.parseModuleSpecifier();
						...
						if (this.match("{") ? i = i.concat(this.parseNamedImports()) : this.match("*") ? i.push(this.parseImportNamespaceSpecifier()) : this.isIdentifierName(this.lookahead) && !this.matchKeyword("default") ? (i.push(this.parseImportDefaultSpecifier()), this.match(",") && (this.nextToken(), this.match("*") ? i.push(this.parseImportNamespaceSpecifier()) : this.match("{") ? i = i.concat(this.parseNamedImports()) : this.throwUnexpectedToken(this.lookahead))) : this.throwUnexpectedToken(this.nextToken()), !this.matchContextualKeyword("from")) {
							var s = this.lookahead.value ? f.Messages.UnexpectedToken : f.Messages.MissingFromClause;
							this.throwError(s, this.lookahead.value)
						}
						this.nextToken(), e = this.parseModuleSpecifier()
					}
					return this.consumeSemicolon(), this.finalize(t, new E.ImportDeclaration(i, e))
				}, e.prototype.parseExportSpecifier = function() {
					var e = this.createNode(),
						t = this.parseIdentifierName(),
						i = t;
					return this.matchContextualKeyword("as") && (this.nextToken(), i = this.parseIdentifierName()), this.finalize(e, new E.ExportSpecifier(t, i))
					...
					if (this.expectKeyword("export"), this.matchKeyword("default"))
						if (this.nextToken(), this.matchKeyword("function")) {
							...
							e = this.finalize(t, new E.ExportDefaultDeclaration(i))
						...
						this.matchContextualKeyword("from") && this.throwError(f.Messages.UnexpectedToken, this.lookahead.value);
						i = this.match("{") ? this.parseObjectInitializer() : this.match("[") ? this.parseArrayInitializer() : this.parseAssignmentExpression();
						this.consumeSemicolon(), e = this.finalize(t, new E.ExportDefaultDeclaration(i))
					} else if (this.match("*")) {
						...
						this.consumeSemicolon(), e = this.finalize(t, new E.ExportAllDeclaration(r))
						...
						e = this.finalize(t, new E.ExportNamedDeclaration(i, [], null))
						...
						var n = [],
							a = null,
							o = !1;
						for (this.expect("{"); !this.match("}");) o = o || this.matchKeyword("default"), n.push(this.parseExportSpecifier()), this.match("}") || this.expect(",");
						if (this.expect("}"), this.matchContextualKeyword("from")) this.nextToken(), a = this.parseModuleSpecifier(), this.consumeSemicolon();
						else if (o) {
							s = this.lookahead.value ? f.Messages.UnexpectedToken : f.Messages.MissingFromClause;
							this.throwError(s, this.lookahead.value)
						} else this.consumeSemicolon();
						e = this.finalize(t, new E.ExportNamedDeclaration(null, n, a))
					}
					return e
				}, e
			}();
		...
		var i = function() {
			...
			return e.prototype.recordError = function(e) {
				...
				return n.index = e, n.lineNumber = t, n.description = s, n
		...
		var n = function() {
			function e(e, t) {
				this.source = e, this.errorHandler = t, this.trackComment = !1, this.isModule = !1, this.length = e.length, this.index = 0, this.lineNumber = 0 < e.length ? 1 : 0, this.lineStart = 0, this.curlyStack = []
			}
			return e.prototype.saveState = function() {
				...
				return void 0 === e && (e = l.Messages.UnexpectedTokenIllegal), this.errorHandler.throwError(this.index, this.lineNumber, this.index - this.lineStart + 1, e)
			}, e.prototype.tolerateUnexpectedToken = function(e) {
				void 0 === e && (e = l.Messages.UnexpectedTokenIllegal), this.errorHandler.tolerateError(this.index, this.lineNumber, this.index - this.lineStart + 1, e)
			}, e.prototype.skipSingleLineComment = function(e) {
				var t, i, s = [];
				for (this.trackComment && (s = [], t = this.index - e, i = {
						start: {
					...
					if (++this.index, c.Character.isLineTerminator(r)) {
				...
				for (this.trackComment && (i = [], e = this.index - 2, t = {
					...
					if (c.Character.isLineTerminator(s)) 13 === s && 10 === this.source.charCodeAt(this.index + 1) && ++this.index, ++this.lineNumber, ++this.index, this.lineStart = this.index;
					else if (42 === s) {
				...
				for (var t = 0 === this.index; !this.eof();) {
					...
					else if (c.Character.isLineTerminator(i)) ++this.index, 13 === i && 10 === this.source.charCodeAt(this.index) && ++this.index, ++this.lineNumber, this.lineStart = this.index, t = !0;
					else if (47 === i)
				...
				if (55296 <= t && t <= 56319) {
					...
					if (56320 <= i && i <= 57343) t = 1024 * (t - 55296) + i - 56320 + 65536
				}
				return t
			}, e.prototype.scanHexEscape = function(e) {
				for (var t = "u" === e ? 4 : 2, i = 0, s = 0; s < t; ++s) {
					if (this.eof() || !c.Character.isHexDigit(this.source.charCodeAt(this.index))) return null;
					i = 16 * i + r(this.source[this.index++])
				}
				return String.fromCharCode(i)
			}, e.prototype.scanUnicodeCodePointEscape = function() {
				var e = this.source[this.index],
					t = 0;
				for ("}" === e && this.throwUnexpectedToken(); !this.eof() && (e = this.source[this.index++], c.Character.isHexDigit(e.charCodeAt(0)));) t = 16 * t + r(e);
				return (1114111 < t || "}" !== e) && this.throwUnexpectedToken(), c.Character.fromCodePoint(t)
				...
				for (var e = this.index++; !this.eof();) {
					...
					if (55296 <= t && t < 57343) return this.index = e, this.getComplexIdentifier();
					if (!c.Character.isIdentifierPart(t)) break;
					++this.index
				}
				return this.source.slice(e, this.index)
			}, e.prototype.getComplexIdentifier = function() {
				var e, t = this.codePointAt(this.index),
					i = c.Character.fromCodePoint(t);
				for (this.index += i.length, 92 === t && (117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e = this.scanUnicodeCodePointEscape()) : null !== (e = this.scanHexEscape("u")) && "\\" !== e && c.Character.isIdentifierStart(e.charCodeAt(0)) || this.throwUnexpectedToken(), i = e); !this.eof() && (t = this.codePointAt(this.index), c.Character.isIdentifierPart(t));) i += e = c.Character.fromCodePoint(t), this.index += e.length, 92 === t && (i = i.substr(0, i.length - 1), 117 !== this.source.charCodeAt(this.index) && this.throwUnexpectedToken(), ++this.index, "{" === this.source[this.index] ? (++this.index, e = this.scanUnicodeCodePointEscape()) : null !== (e = this.scanHexEscape("u")) && "\\" !== e && c.Character.isIdentifierPart(e.charCodeAt(0)) || this.throwUnexpectedToken(), i += e);
				return i
			}, e.prototype.octalToDecimal = function(e) {
				var t = "0" !== e,
					i = s(e);
				return !this.eof() && c.Character.isOctalDigit(this.source.charCodeAt(this.index)) && (t = !0, i = 8 * i + s(this.source[this.index++]), 0 <= "0123".indexOf(e) && !this.eof() && c.Character.isOctalDigit(this.source.charCodeAt(this.index)) && (i = 8 * i + s(this.source[this.index++]))), {
					code: i,
					octal: t
				}
				...
				if (3 !== (e = 1 === i.length ? 3 : this.isKeyword(i) ? 4 : "null" === i ? 5 : "true" === i || "false" === i ? 1 : 3) && t + i.length !== this.index) {
					var s = this.index;
					this.index = t, this.tolerateUnexpectedToken(l.Messages.InvalidEscapedReservedWord), this.index = s
				}
				return {
					type: e,
					value: i,
				...
				switch (t) {
					...
					case "~":
						...
						break;
					default:
						">>>=" === (t = this.source.substr(this.index, 4)) ? this.index += 4: "===" === (t = t.substr(0, 3)) || "!==" === t || ">>>" === t || "<<=" === t || ">>=" === t || "**=" === t ? this.index += 3 : "&&" === (t = t.substr(0, 2)) || "||" === t || "==" === t || "!=" === t || "+=" === t || "-=" === t || "*=" === t || "/=" === t || "++" === t || "--" === t || "<<" === t || ">>" === t || "&=" === t || "|=" === t || "^=" === t || "%=" === t || "<=" === t || ">=" === t || "=>" === t || "**" === t ? this.index += 2 : (t = this.source[this.index], 0 <= "<>=!+-*%&|^/".indexOf(t) && ++this.index)
				}
				...
				for (var t = ""; !this.eof() && c.Character.isHexDigit(this.source.charCodeAt(this.index));) t += this.source[this.index++];
				return 0 === t.length && this.throwUnexpectedToken(), c.Character.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), {
					type: 6,
				...
				return 0 === i.length && this.throwUnexpectedToken(), this.eof() || (t = this.source.charCodeAt(this.index), (c.Character.isIdentifierStart(t) || c.Character.isDecimalDigit(t)) && this.throwUnexpectedToken()), {
					type: 6,
					value: parseInt(i, 2),
					lineNumber: this.lineNumber,
					lineStart: this.lineStart,
				...
				var i = "",
					s = !1;
				for (c.Character.isOctalDigit(e.charCodeAt(0)) ? (s = !0, i = "0" + this.source[this.index++]) : ++this.index; !this.eof() && c.Character.isOctalDigit(this.source.charCodeAt(this.index));) i += this.source[this.index++];
				return s || 0 !== i.length || this.throwUnexpectedToken(), (c.Character.isIdentifierStart(this.source.charCodeAt(this.index)) || c.Character.isDecimalDigit(this.source.charCodeAt(this.index))) && this.throwUnexpectedToken(), {
					type: 6,
					value: parseInt(i, 8),
					octal: s,
					lineNumber: this.lineNumber,
				...
				for (var e = this.index + 1; e < this.length; ++e) {
					var t = this.source[e];
					if ("8" === t || "9" === t) return !1;
					if (!c.Character.isOctalDigit(t.charCodeAt(0))) return !0
				}
				return !0
			}, e.prototype.scanNumericLiteral = function() {
				var e = this.index,
					t = this.source[e];
				u.assert(c.Character.isDecimalDigit(t.charCodeAt(0)) || "." === t, "Numeric literal must start with a decimal digit or a decimal point");
				var i = "";
				if ("." !== t) {
					if (i = this.source[this.index++], t = this.source[this.index], "0" === i) {
						...
						if (t && c.Character.isOctalDigit(t.charCodeAt(0)) && this.isImplicitOctalLiteral()) return this.scanOctalLiteral(t, e)
					}
					for (; c.Character.isDecimalDigit(this.source.charCodeAt(this.index));) i += this.source[this.index++];
					t = this.source[this.index]
				}
				if ("." === t) {
					for (i += this.source[this.index++]; c.Character.isDecimalDigit(this.source.charCodeAt(this.index));) i += this.source[this.index++];
					t = this.source[this.index]
				}
				if ("e" === t || "E" === t)
					if (i += this.source[this.index++], "+" !== (t = this.source[this.index]) && "-" !== t || (i += this.source[this.index++]), c.Character.isDecimalDigit(this.source.charCodeAt(this.index)))
						for (; c.Character.isDecimalDigit(this.source.charCodeAt(this.index));) i += this.source[this.index++];
					else this.throwUnexpectedToken();
				return c.Character.isIdentifierStart(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(), {
					type: 6,
					value: parseFloat(i),
					lineNumber: this.lineNumber,
					lineStart: this.lineStart,
				...
				for (var i = !1, s = ""; !this.eof();) {
					...
					if ("\\" === r)
						if ((r = this.source[this.index++]) && c.Character.isLineTerminator(r.charCodeAt(0))) ++this.lineNumber, "\r" === r && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index;
						else switch (r) {
							case "u":
								if ("{" === this.source[this.index]) ++this.index, s += this.scanUnicodeCodePointEscape();
								else {
									var n = this.scanHexEscape(r);
									null === n && this.throwUnexpectedToken(), s += n
								}
								break;
							case "x":
								var a = this.scanHexEscape(r);
								null === a && this.throwUnexpectedToken(l.Messages.InvalidHexEscapeSequence), s += a;
								break;
							case "n":
								s += "\n";
								break;
							...
							case "8":
							case "9":
								s += r, this.tolerateUnexpectedToken();
								break;
							default:
								if (r && c.Character.isOctalDigit(r.charCodeAt(0))) {
									var o = this.octalToDecimal(r);
									i = o.octal || i, s += String.fromCharCode(o.code)
								} else s += r
						} else {
							if (c.Character.isLineTerminator(r.charCodeAt(0))) break;
							s += r
						}
				}
				...
				for (++this.index; !this.eof();) {
					...
					if ("$" === a) {
						...
						if (a = this.source[this.index++], c.Character.isLineTerminator(a.charCodeAt(0))) ++this.lineNumber, "\r" === a && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index;
						else switch (a) {
							case "n":
								e += "\n";
								break;
							...
							case "u":
								if ("{" === this.source[this.index]) ++this.index, e += this.scanUnicodeCodePointEscape();
									...
									var o = this.index,
										u = this.scanHexEscape(a);
									null !== u ? e += u : (this.index = o, e += a)
								}
								break;
							case "x":
								var h = this.scanHexEscape(a);
								null === h && this.throwUnexpectedToken(l.Messages.InvalidHexEscapeSequence), e += h;
								break;
							case "b":
								e += "\b";
								break;
							...
							case "v":
								...
								break;
							default:
								"0" === a ? (c.Character.isDecimalDigit(this.source.charCodeAt(this.index)) && this.throwUnexpectedToken(l.Messages.TemplateOctalLiteral), e += "\0") : c.Character.isOctalDigit(a.charCodeAt(0)) ? this.throwUnexpectedToken(l.Messages.TemplateOctalLiteral) : e += a
						} else c.Character.isLineTerminator(a.charCodeAt(0)) ? (++this.lineNumber, "\r" === a && "\n" === this.source[this.index] && ++this.index, this.lineStart = this.index, e += "\n") : e += a
				}
				return t || this.throwUnexpectedToken(), s || this.curlyStack.pop(), {
					type: 10,
					value: this.source.slice(i + 1, this.index - n),
					cooked: e,
					head: s,
					tail: r,
					lineNumber: this.lineNumber,
				...
				var i = e,
					r = this;
				0 <= t.indexOf("u") && (i = i.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g, function(e, t, i) {
					var s = parseInt(t || i, 16);
					return 1114111 < s && r.throwUnexpectedToken(l.Messages.InvalidRegExp), s <= 65535 ? String.fromCharCode(s) : "￿"
				}).replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, "￿"));
				try {
					RegExp(i)
				} catch (e) {
					this.throwUnexpectedToken(l.Messages.InvalidRegExp)
				}
				try {
				...
				for (var t = this.source[this.index++], i = !1, s = !1; !this.eof();)
					if (t += e = this.source[this.index++], "\\" === e) e = this.source[this.index++], c.Character.isLineTerminator(e.charCodeAt(0)) && this.throwUnexpectedToken(l.Messages.UnterminatedRegExp), t += e;
					else if (c.Character.isLineTerminator(e.charCodeAt(0))) this.throwUnexpectedToken(l.Messages.UnterminatedRegExp);
				else if (i) "]" === e && (i = !1);
				else {
					if ("/" === e) {
						s = !0;
				...
				return s || this.throwUnexpectedToken(l.Messages.UnterminatedRegExp), t.substr(1, t.length - 2)
			}, e.prototype.scanRegExpFlags = function() {
				for (var e = ""; !this.eof();) {
					var t = this.source[this.index];
					if (!c.Character.isIdentifierPart(t.charCodeAt(0))) break;
					if (++this.index, "\\" !== t || this.eof()) e += t, t;
						...
						if (null !== s)
							for (e += s, "\\u"; i < this.index; ++i) this.source[i];
						else this.index = i, e += "u", "\\u";
		...
		var s = i(10),
			...
			n = function() {
				...
				return e.prototype.beforeFunctionExpression = function(e) {
					return 0 <= ["(", "{", "[", "in", "typeof", "instanceof", "new", "return", "case", "delete", "throw", "void", "=", "+=", "-=", "*=", "**=", "/=", "%=", "<<=", ">>=", ">>>=", "&=", "|=", "^=", ",", "+", "-", "*", "**", "/", "%", "++", "--", "<<", ">>", ">>>", "&", "|", "^", "!", "~", "&&", "||", "?", ":", "===", "==", ">=", "<=", "<", ">", "!=", "!=="].indexOf(e)
					...
					switch (e) {
						...
						case ")":
							...
							break;
						case "}":
							if (t = !1, "function" === this.values[this.curly - 3]) t = !!(s = this.values[this.curly - 4]) && !this.beforeFunctionExpression(s);
			...
			a = function() {
				function e(e, t) {
					this.errorHandler = new s.ErrorHandler, this.errorHandler.tolerant = !!t && ("boolean" == typeof t.tolerant && t.tolerant), this.scanner = new r.Scanner(e, this.errorHandler), this.scanner.trackComment = !!t && ("boolean" == typeof t.comment && t.comment), this.trackRange = !!t && ("boolean" == typeof t.range && t.range), this.trackLoc = !!t && ("boolean" == typeof t.loc && t.loc), this.buffer = [], this.reader = new n
				}
				return e.prototype.errors = function() {
					...
					if (0 === this.buffer.length) {
						...
						if (!this.scanner.eof()) {
							...
							this.reader.push(a);
							var o = {
								type: c.TokenName[a.type],
								value: this.scanner.source.slice(a.start, a.end)
							};
							if (this.trackRange && (o.range = [a.start, a.end]), this.trackLoc && (n.end = {
									line: this.scanner.lineNumber,
									column: this.scanner.index - this.scanner.lineStart
								}, o.loc = n), 9 === a.type) {
								var u = a.pattern,
...
/* html-react */
! function(e, t) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = t(require("react")) : "function" == typeof define && define.amd ? define(["react"], t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).HTMLReactParser = t(e.React)
}(this, (function(e) {
	"use strict";
